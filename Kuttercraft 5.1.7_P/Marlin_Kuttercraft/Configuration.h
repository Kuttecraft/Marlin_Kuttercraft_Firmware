...
//===========================================================================
//========================= Modelo de kuttercraft ===========================
//===========================================================================
// PK1 - PK2 - PK2++ - PK3 - PK3++ - PK3+E
//
//#define PK3
//#define PK3_Plus_Plus
#define PK3_Plus_Ext

#if ENABLED(PK3)
  #define MODELO_DE_MAQUINA "PK3"
#elif ENABLED(PK3_Plus_Plus)
  #define MODELO_DE_MAQUINA "PK3++"
#elif ENABLED(PK3_Plus_Ext)
  #define MODELO_DE_MAQUINA "PK3+E"
#endif
//===========================================================================
//============================= SCARA Printer ===============================
//===========================================================================
...
#define STRING_CONFIG_H_AUTHOR "(Kuttercraft, SKR 1.41)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1600, 1600, 400, 415 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 100, 30 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 44, -44, 0 }
...
#define XY_PROBE_SPEED_ (4000)
#define SPEED_TRAVEL_PROBIN (3000)
...
#define X_BED_SIZE 240 //120 es la mitad
#if ENABLED(PK3)
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define LEVELED_SEGMENT_LENGTH 0.0 // (mm) Length of all segments (except the last one)
