 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 220        // Seconds
 ...
 */
  ...
  //#define MESH_MAX_Y Y_BED_SIZE - (1)

  #define MESH_MIN_X 45 //Tiene que ser mas grande que el offset X
  #define MESH_MIN_Y 25
  #define MESH_MAX_X X_BED_SIZE - 0 //Limitamos mas el mapa por le borde izquierdo de la maquina
