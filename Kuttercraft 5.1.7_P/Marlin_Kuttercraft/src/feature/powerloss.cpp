...
void PrintJobRecovery::resume() {
  ...
  gcode.process_subcommands_now_P(PSTR("G28 X Y"));


  SERIAL_ECHOPGM("Poccicion de eje x y\n");
  SERIAL_ECHOPGM("EJE X:");
  SERIAL_ECHOLN(info.current_position.x);
  SERIAL_ECHOPGM("\n");

  SERIAL_ECHOPGM("EJE Y:");
  SERIAL_ECHOLN(info.current_position.y);
  SERIAL_ECHOPGM("\n");
