...
void cargar(){
  MarlinUI::retirar_o_cargar = true;
  pause_menu_response = PAUSE_RESPONSE_EXTRUDE_MORE;
}
void retirar(){
  MarlinUI::retirar_o_cargar = false;
  pause_menu_response = PAUSE_RESPONSE_EXTRUDE_MORE;
}
void menu_pause_option() {
    ...
    crear_boton(cargar_boton_a,  cargar_boton_b,    Language_es::MSG_FILAMENTLOAD,     cargar);
    crear_boton(retirar_boton_a, retirar_boton_b,   Language_es::MSG_FILAMENTUNLOAD,   retirar);
    crear_boton(seguir_boton_a,  seguir_boton_b,    Language_es::MSG_RESUME_PRINT,     reanudar);
}
#else
void menu_pause_option() {
  START_MENU();
