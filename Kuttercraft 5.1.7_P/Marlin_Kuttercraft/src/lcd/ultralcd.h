...
public:
  ...
  static void clear_lcd();
    ...
    static void save_previous_screen();
      ...
      static int ultimo_valor_encoder;
      static int endcoder_ulti_aux;
      static screenFunc_t ultimo_valor_ventana;
      static char contenedor_str[35];
      static char numero_de_serie[16];
      static int encoder_giro;

      static char capa_actual[16];
      static char total_de_capas[16];

      static int mostar_un_solo_logro;
      static int numero_de_logro_km;
      static int numero_de_logro_pz;

      static bool salida_de_menu;

      static bool retirar_o_cargar;

      static bool salida_pid;

      //variables de guardado
      static bool calibracion_on_off;
      static bool informacion_capas_coord;
      static bool inductivo_final_carrera;
      static bool tipo_de_extrusor;
      static bool guardado_on_off;
      static bool sensor_on_off;
      static bool encode_der_izd;
      static bool paso_de_varrilla;
      static bool k_melody_on_off;

      static void sonar_kuttermelody();
      static void sonar_kutterajustes();

      static bool mover_a_punto;
  ...
  //
    ...
    FORCE_INLINE static void encoder_direction_normal() {
      #if EITHER(REVERSE_MENU_DIRECTION, REVERSE_SELECT_DIRECTION)
        encoderDirection = encoder_giro;
      #endif
    }

    FORCE_INLINE static void encoder_direction_menus() {
      TERN_(REVERSE_MENU_DIRECTION, encoderDirection = -(encoder_giro));
    }

    FORCE_INLINE static void encoder_direction_select() {
      TERN_(REVERSE_SELECT_DIRECTION, encoderDirection = -(encoder_giro));
    }
